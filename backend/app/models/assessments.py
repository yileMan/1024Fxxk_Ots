...
class ProductAssessment(Base):
    ...
    assessment_basis_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    assessment_basis_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    reassess_changes_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
