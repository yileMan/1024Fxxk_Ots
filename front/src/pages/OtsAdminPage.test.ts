...
describe('OtsAdminPage', () => {
  it('shows the OTS version but hides the record version from the list', async () => {
    ...
    expect(wrapper.get('thead').text()).toContain('OTS 版本')
    expect(list).toContain(ots.ots_version)
